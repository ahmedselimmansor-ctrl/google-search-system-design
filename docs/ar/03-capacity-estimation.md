...
| مع غير HTML والبيانات الوصفية للوسائط والمجلوب غير المفهرس | لا ينطبق | **عشرات إلى مئات البيتابايت** |
...
| **الإجمالي المقيم في الخدمة (نسخة واحدة)** | لا ينطبق | **~600 تيرابايت ≈ 0.6 بيتابايت** |
...
| PageRank بـ٣٠ تكرارًا | 10¹¹ عقدة، ~10¹² حافة | لا ينطبق | ~ساعات |
